...
INSERT INTO `atributo_producto` VALUES (1,1,'7'),(1,2,'8'),(1,3,'m'),(1,4,'p'),(1,5,'L');
...
CREATE TABLE `auditoria_producto` (
  ...
  `campo` varchar(100) COLLATE utf8mb4_spanish_ci NOT NULL,
  `valor_anterior` varchar(255) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
  `valor_nuevo` varchar(255) COLLATE utf8mb4_spanish_ci DEFAULT NULL,
...
INSERT INTO `categoria` VALUES (1,'EPP'),(2,'CONSUMIBLES'),(3,'prueba');
...
INSERT INTO `detalle_entrega` VALUES (1,1,3,1,'dotacion','2025-10-16 20:06:30','2025-10-16 20:06:30');
...
INSERT INTO `entrega` VALUES (1,1,'2025-10-16','RIO GRANDE','ROBERTO',5,'2025-10-16 20:06:30','2025-10-16 20:06:30');
...
INSERT INTO `producto` VALUES (1,1,'GUANTES VAQUETA','PAR',0,'2025-10-15 20:24:07','2025-10-15 20:24:07'),(2,1,'GUANTES VAQUETA','PAR',0,'2025-10-15 20:26:45','2025-10-15 20:26:45'),(3,1,'camisa','unidad',-1,'2025-10-16 19:48:37','2025-10-16 22:24:02'),(4,1,'camisa','unidad',0,'2025-10-16 19:52:05','2025-10-16 22:24:02'),(5,1,'camisa','unidad',0,'2025-10-16 19:56:10','2025-10-16 22:24:02');
...
-- Dump completed on 2025-10-16 23:30:29
